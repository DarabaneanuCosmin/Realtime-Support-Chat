...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../fonts/fontsAwesome/awesome.css" />
    <link rel="stylesheet" href="../css/header.css" />
    <link rel="stylesheet" href="../css/popularLocations.css" />
  ...
  <body>
    ...
    <div class="principal_buttons">
      <button>Home</button>
      <a href="../home/about/"><button>About</button></a>
      <a href="../home/adminpanel/"><button >Admin Panel</button></a>
    </div>
    <main>
          ...
          <div class="chatBoxStatic__recentConversationsList">
            ...
            <div class="chatBoxStatic__conversation" onclick="hideConvList()">
              <div class="chatBoxStatic__recentConversationAvatar">
                <img src="../img/nd-initials.jpg" alt="Initials" />
              </div>
