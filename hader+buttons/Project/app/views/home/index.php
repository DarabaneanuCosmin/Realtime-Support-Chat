...
<body>
    ...
    <main>
        <div id="register_modal" class="modal" onclick="closeRegisterWindow()">
            <div id="form_modal_register">
                <form class="form_container" id="formcont" method="post" action="../home/register/">
                    <h3>Register</h3>
                    ...
                    <button type="submit" id="form_button" name="submit">Register</button>
                </form>
                <button onclick="closeRegisterForm()" class="close_register">X</button>
            </div>
        </div>
        
        <div id="login_modal" class="modal" onclick="closeLoginWindow()">
            <div id="form_modal_login">
                <form class="form_container" id="formcont">
                    <h3>Login</h3>
                    <label for="username"><b>Username</b></label>
                    <input type="text" placeholder="Enter Username" name="username" required>
